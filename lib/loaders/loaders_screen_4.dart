...
class loadersScreen4 extends StatefulWidget {
  final double radius;
  final double dotRadius;

  // ignore: use_key_in_widget_constructors
  const loadersScreen4({required this.radius, required this.dotRadius});

  @override
  _loadersScreen4State createState() => _loadersScreen4State();
}

// ignore: camel_case_types
class _loadersScreen4State extends State<loadersScreen4>
